...
public class DragSpellOnTarget : DraggingActions {
    ...
    public TargetingOptions Targets = TargetingOptions.AllCharacter;
        ...
        if (Target != null)
        {
            ...
            switch (Targets)
            {
                ...
                case TargetingOptions.AllMonster:
                    ...
                    break;
                case TargetingOptions.EnemyCharacter:
                    ...
                    break;
                case TargetingOptions.EnemyMonster:
                    if (Target.tag.Contains("Creature"))
                    {
                    ...
                    break;
                case TargetingOptions.YourCharacter:
                    if (Target.tag.Contains("Creature") || Target.tag.Contains("Player"))
                    {
                        // had to check that target is not a card
                    ...
                    break;
                case TargetingOptions.YourMonster:
                    if (Target.tag.Contains("Creature"))
                    {
                        // had to check that target is not a card or a player
                        if ((tag.Contains("Low") && Target.tag.Contains("Low"))
