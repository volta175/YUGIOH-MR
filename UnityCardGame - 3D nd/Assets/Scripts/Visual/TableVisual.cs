...
public class TableVisual : MonoBehaviour 
{
    ...
    public void AddCreatureAtIndex(CardAsset ca, int UniqueID ,int index)
    {
       /*
        ...
        GameObject creature = GameObject.Instantiate(GlobalSettings.Instance.CreatureCardPrefab, slots.Children[index].transform.position, Quaternion.identity) as GameObject;

        // apply the look from CardAsset
        OneCardManager manager = creature.GetComponent<OneCardManager>();
       // Debug.Log(creature.GetComponent<OneCardManager>());
